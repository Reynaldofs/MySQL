...
values ("felipe", "Calabresa");
insert into tb_categorias(nome, sabor)
values ("vitoria", "Portuguesa");
insert into tb_categorias(nome, sabor)
values ("mconze", "Napolitana");
insert into tb_categorias(nome, sabor)
values ("lucas", "Mussarela");
insert into tb_categorias(nome, sabor)
values ("flavia", "Catupiry");
...
insert into tb_pizzas(preco, quantidade, borda_recheada, descricao, categorias_id)
values (100, 1, false, "Napolitana, frango, Catupiry, sálvia e base de molho de tomate. (ESPECIAL FAMILIA)", 3);
insert into tb_pizzas(preco, quantidade, borda_recheada, descricao, categorias_id)
...
insert into tb_pizzas(preco, quantidade, borda_recheada, descricao, categorias_id)
values (50, 2, false, "Napolitana, frango, Catupiry, sálvia e base de molho de tomate.", 3);
